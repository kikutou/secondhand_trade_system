...
class MessagesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->dateTime('readed_by_from_user_at')
            ->allowEmptyDateTime('readed_by_from_user_at');

        $validator
            ->dateTime('readed_by_to_user_at')
            ->allowEmptyDateTime('readed_by_to_user_at');

        $validator
            ->dateTime('readed_by_admin')
            ->allowEmptyDateTime('readed_by_admin');

        $validator
            ->dateTime('canceled_at')
            ->allowEmptyDateTime('canceled_at');
